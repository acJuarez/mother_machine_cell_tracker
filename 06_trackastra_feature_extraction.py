"""
This is the feature extraction homolog to the 04 + 05 of the original napari pipeline
Instead now cell features are extracted from trackastra outputs with assigned lineages from
trackastra graph outputs

Process follows the following general steps:
